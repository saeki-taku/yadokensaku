...
interface MypageFavoriteListProps {
	isLimit: boolean;
}

const MypageFavoriteList = ({ isLimit }: MypageFavoriteListProps) => {
	// Zustandの状態を取得
	...
	return (
		<div className={`${styles.list_wrap} ${styles.favorite}`}>
			<div className={styles.list_title}>{isLimit ? <span>最近追加したお気に入り</span> : <span>お気に入りリスト</span>}</div>
						...
						return (
							<li key={hotelBasicData.hotelNo}>
								...
								<div className={styles.img_box}>
									<figure>
										<ImgLinkCheck link={hotelBasicData.hotelImageUrl} width={1000} height={750} alt="" />
										{/* <Image
								...
								<div className={styles.text_box}>
									...
									<div className={styles.info_evaluation}>
										<div className={styles.kuchikomi}>
											...
											<span className={styles.average}>{hotelBasicData.reviewAverage && hotelBasicData.reviewAverage.toFixed(2)}</span>
											<div className={styles.box}>
												<ReactStarsRating isEdit={false} size={15} value={hotelBasicData.reviewAverage ? hotelBasicData.reviewAverage : 0} />
