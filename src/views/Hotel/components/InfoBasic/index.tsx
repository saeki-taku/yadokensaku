...
const InfoBasic = ({ hotelBasicInfo, hotelDetailInfo, hotelFacilitiesInfo }: ANY_OBJECT) => {
	return (
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<span className="rearText">（{hotelBasicInfo.hotelKanaName}）</span>
						</td>
					</tr>
					<tr>
						<th>住所</th>
					...
					<tr>
						...
						<td>
							...
							<span className="rearText">最終チェックイン（{hotelDetailInfo.lastCheckinTime}）</span>
						</td>
					</tr>
					<tr>
						<th>チェックアウト</th>
						...
						<td>
							<ul className="list">
								{hotelFacilitiesInfo.hotelFacilities.map((value: ANY_OBJECT) => (
									<li className="item" key={value.item}>
										{value.item}
									</li>
								))}
							</ul>
